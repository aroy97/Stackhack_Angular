...
export class EventComponent implements OnInit {
      ...
      .then((response: HttpResponse<any>) => {
        ...
        if (response.status == 200) {
          ...
          if(elem.eventVideo){
            ...
            this.video_link = "https://youtube.com/embed/"+ this.video_id +"?autoplay=1&controls=0&loop=1&showinfo=0&autohide=1&mute=1";
          } else {
            this.video = false;
          }
          // console.log(response.body);
  ...
  getVideoURL() {
    return this.sanitizer.bypassSecurityTrustResourceUrl(this.video_link);
  }
